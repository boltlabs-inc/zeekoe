...
use zeekoe::{
    customer::database::StateName as CustomerStatus, database::ClosingBalances,
...
pub fn tests() -> Vec<Test> {
    vec![
        Test {
            name: "Customer close where customer has full balance is successful".to_string(),
            operations: vec![
                (
        ...
        Test {
            name: "Customer close where merchant has full balance is successful".to_string(),
            operations: vec![
                (
                    Operation::Establish(DEFAULT_BALANCE),
                    Outcome {
        ...
        Test {
            name: "Customer close where both parties have some balance is successful".to_string(),
            operations: vec![
                (
                    Operation::Establish(DEFAULT_BALANCE),
                    Outcome {
        ...
        Test {
            name: "Customer close on non-established channel fails".to_string(),
            operations: vec![(
                Operation::CustomerClose,
                Outcome {

...
pub mod types {
    ...
    impl TezosKeyPair {
        ...
        pub fn read_key_pair(_path: impl AsRef<Path>) -> Result<TezosKeyPair, Error> {
            todo!()
            /* NOTE: this code block should work - I manually tested with the strings generated by
